...
{
    public class AuctionDocumentRepository(JasmimDbContext context, IUnitOfWork unitOfWork)
        : RepositoryBase<AuctionDocument>(context, unitOfWork), IAuctionDocumentRepository
    {
    }
}
