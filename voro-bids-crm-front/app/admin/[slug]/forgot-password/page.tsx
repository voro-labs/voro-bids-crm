...
export default function SlugForgotPasswordPage() {
      ...
      <div className="flex min-h-screen items-center justify-center bg-background p-4">
        <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-lg text-center">
          ...
          <div className="flex flex-col gap-3">
            ...
            <Button variant="outline" onClick={() => router.push(`/admin/${slug}/sign-in`)} className="w-full gap-2">
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md rounded-2xl border border-border bg-card p-8 shadow-lg">
        <TenantBrandHeader tenant={tenant} icon={<Mail className="h-7 w-7" />} />
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-4">
          ...
          <Button
            type="button"
            variant="outline"
            onClick={() => router.push(`/admin/${slug}/sign-in`)}
            disabled={loading}
